    ...
    return (
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-content  mt-10">
                {/* <!-- Page content here --> */}
                {/* <label htmlFor="my-drawer-2" className="btn text-4xl drawer-button bg-transparent text-black border-none hover:text-white">Open</label> */}
                <Outlet />
            </div>
...

                    {
                        isAdmin ?
                            <>
                                ...
                                <li><NavLink to="/dashboard/history"> <ImSpoonKnife /> Add Items </NavLink>  </li>
                                <li><NavLink to="/dashboard/myCart" > <CgMenuGridR /> Manage Items</NavLink> </li>
